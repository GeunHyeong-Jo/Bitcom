...
<ul class="navbar-nav ml-auto">
	<c:choose>
		...
		<c:otherwise>
			...
			<li>
			<li class="nav-item"><a class="nav-link"
				href="${pageContext.request.contextPath }/cart">장바구니</a>
			<li>
			<li class="nav-item"><a class="nav-link"
				href="${pageContext.request.contextPath }/order/make">주문</a>
			<li>
			<li class="nav-item"><a class="nav-link"
				href="${pageContext.request.contextPath }/order/inquiry">주문조회</a>
			<li>
		</c:otherwise>
	</c:choose>
