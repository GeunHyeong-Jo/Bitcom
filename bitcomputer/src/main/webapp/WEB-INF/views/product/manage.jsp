				...
				<div class="card card-outline-secondary my-4">
					...
					<div class="card-body">
						...
						<form method="post" enctype="multipart/form-data"
							...
							</select> <label class="block-label">제품명</label> <input name="pname"
								type="text" value=""> <label class="block-label">가격</label>
							<input name="pprice" type="number" step="500" min="500" value="">
							<br /> <label class="block-label">제조사</label> <input
								name="pmanufacturer" type="text" value=""> <label
								class="block-label">소켓(슬롯)</label> <input name="psocket"
								type="text" value=""> <br /> <label class="block-label">제품
								상세정보</label>
							<textarea name="pcontent"></textarea>
							<br /> <label class="block-label">재고량</label> <input name="pqty"
								type="number" min="1" value=""> <input type="file"
								name="file"> <input type="submit" value="업로드">
						</form>
						<!--                -->
						<hr />
						...
						<div class="col-lg-4 col-md-6 mb-4">
							<div class="card h-100">
								<img class="card-img-top"
									src="${pageContext.request.contextPath }/${productVo.pimage }"
									alt="..." />
								<div class="card-body">
									<h4 class="card-title">
										<a>${productVo.pname }</a>
									...
									<button onclick="location.href='${pageContext.request.contextPath }/product/delete?no=${productVo.pno}'">제품 삭제하기</button>
